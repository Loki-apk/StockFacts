"""-> FundamentalsReport, wrapping each raw provider number in a MetricWithContext.

This module only fills in `value`, `unit`, `as_of`, and `source` — the peer
and sector median fields stay None here and get filled in later, once
valuation_context.py and peers.py have run.
"""
...
from stockfact.models.reports import FundamentalsReport, MetricWithContext
