"""Company news. yfinance's feed is the zero-config default; Finnhub is used
instead when ``FINNHUB_API_KEY`` is set (deeper history, cleaner fields).

Returns dicts shaped for ``RawNewsItem``. No summarisation here — that's the
News & Theme agent's job.
"""
