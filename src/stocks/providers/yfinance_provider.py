...
yfinance scrapes Yahoo — it breaks on their HTML changes and rate-limits hard.
Every method converts yfinance's quirks (empty frames, missing keys, exceptions)
into either a clean result or a ``ProviderError``.
"""
...
try:  # keep import failure from killing `import stocks`
