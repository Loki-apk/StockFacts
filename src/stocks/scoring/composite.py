"""Deterministic sub-scores. Pure functions of already-fetched numbers.

Every score is 0-100. A missing input -> that sub-score is None (never a guess),
and the rollup averages only what's present and notes the gap.
"""

from __future__ import annotations

from stocks.models.reports import SubScores
