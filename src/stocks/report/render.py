"""StockEvaluationReport -> Markdown / HTML.

Sections mirror the data model 1:1. Disclaimer on top. Every figure carries a
source + as-of date. There is never a "recommendation" section.
"""
