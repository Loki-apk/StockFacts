"""-> list[RiskFlag] (structured, pre-narrative).

Deterministic thresholds only. The Risk Narrative agent later fleshes out
`description` and confirms `severity`; it may not add flags this layer didn't
raise.
"""
...
from stocks.models.enums import FlagType, Severity
from stocks.models.reports import RiskFlag
