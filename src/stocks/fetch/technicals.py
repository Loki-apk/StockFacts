"""-> TechnicalReport. Indicators computed locally in numpy/pandas.

Never ask the LLM to compute SMA / RSI / beta / vol. It's arithmetic; do it here.
"""
...
from stocks.models.reports import TechnicalReport
